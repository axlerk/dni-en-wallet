// Genera public/pass-assets.js con los PNG fijos del pase (icon/logo 1x/2x/3x) embebidos en base64.
...
fs.writeFileSync(path.join(dir, '..', '..', 'public', 'pass-assets.js'), out);
console.log('public/pass-assets.js:', names.length, 'assets');
